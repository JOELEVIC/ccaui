        ...
        <VStack gap={12} align="stretch">
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} gap={8} w="full">
            {PILLARS.map((pillar) => (
              ...
              <VStack align="flex-start" gap={3} p={6} borderRadius="soft" bg="bgCard" borderWidth="1px" borderColor="blackAlpha.100" boxShadow="var(--shadow-card-soft)" _hover={{ boxShadow: "var(--shadow-card-soft-hover)" }} transition="all 0.2s">
