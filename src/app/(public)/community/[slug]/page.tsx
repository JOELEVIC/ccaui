...
export default function ActivityDetailPage() {
  ...
  if (loading) {
    return (
      <Box bg="bgPrimary" minH="100vh" py={20} textAlign="center" color="textMuted">
        Loading…
      </Box>
    );
  }
  if (error || !a) {
    return (
      <Box bg="bgPrimary" minH="100vh" py={20} textAlign="center">
        <VStack gap={4}>
  ...
  return (
    <Box bg="bgPrimary" minH="100vh" pb={{ base: 12, md: 20 }}>
      {/* Cover */}
      {a.coverImageUrl ? (
